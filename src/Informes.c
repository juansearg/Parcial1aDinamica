...
int inf_adhArcadeConSalon(eArcade listArcade[], int len, int idArcade,char nombreDelJuego[],char nacionalidad[],int tipoDeSonido,int cantidadDeJugadores, int capacidadMaxFichas,int idSalon, int indiceLibre)
{
	...
	{
			listArcade[indiceLibre].idArcade=idArcade;
			listArcade[indiceLibre].idSalon=idSalon;
			strncpy(listArcade[indiceLibre].nombreDelJuego,nombreDelJuego,sizeof(listArcade->nombreDelJuego));
			strncpy(listArcade[indiceLibre].nacionalidad,nacionalidad,sizeof(listArcade->nacionalidad));
			listArcade[indiceLibre].tipoDeSonido=tipoDeSonido;
			listArcade[indiceLibre].cantidadDeJugadores=cantidadDeJugadores;
			listArcade[indiceLibre].capacidadMaxFichas=capacidadMaxFichas;
			listArcade[indiceLibre].isEmpty=OCUPADO;
			return 0;
